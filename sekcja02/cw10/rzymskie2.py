...
Rozwiązanie działa poprawnie dla Python'a 3.6+
"""

if __name__ == '__main__':

    # Słownik konwersji liczb arabskich na rzymskie:
    zamiana = {1000: 'M', 900: 'CM', 500: 'D', 400: 'CD', 100: 'C', 90: 'XC', 50: 'L', 40: 'XL', 10: 'X', 9: 'IX', 5: 'V', 4: 'IV', 1: 'I'}
    ...
    if 1 <= liczba < 4000:
        ...
        # Od Python'a 3.6 słowniki zachowują kolejność wprowadzanych danych, więc można iterować po słowniku:
        for arabska in zamiana:
