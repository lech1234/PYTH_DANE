...
Potrzebne dane: wzrost [m] oraz waga [kg] są wczytywane z klawiatury.

Jeśli indeks BMI jest:
        < 16.00 – wygłodzenie
...
if __name__ == '__main__':
    ...
    # interpretacja liczbowej wartości indeksu
    print('Diagnoza: ', end='')
    if bmi < 16:
        print('wygłodzenie')
    elif bmi < 17:
    ...
    print('Przy Twoim wzroście prawidłowa waga mieści się w przedziale od', ok_min, 'do', ok_max, 'kg')
